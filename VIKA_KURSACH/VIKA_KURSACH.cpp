...
// VIKA_KURSACH.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CVIKAKURSACHApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CVIKAKURSACHApp

CVIKAKURSACHApp::CVIKAKURSACHApp()
{
...
// Единственный объект CVIKAKURSACHApp

CVIKAKURSACHApp theApp;


// Инициализация CVIKAKURSACHApp

BOOL CVIKAKURSACHApp::InitInstance()
{
